...
$yourName = "Olivia Miller";

$yourEmail = "oliviardmiller@gmail.com";

$requiredFields = "name, email";

$successText = "Thanks for getting in touch!";

$errorText = "Oops, looks like you missed a field";
...
- The table with submitted names/values has the class 'confirm-output'
